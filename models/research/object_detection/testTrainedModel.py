...
i = 1
for image_path in glob.glob('D:/MSC/Sem2/AdaptixProject/FactureObjectDetection/Data/fracture/example/*.jpg'):
  ...
  vis_util.visualize_boxes_and_labels_on_image_array(
      ...
      line_thickness=8)
  print("image are saving")
  img = Image.fromarray(image_np)
  img.save(f'image.png_{i}.png')
  i = i+ 1
